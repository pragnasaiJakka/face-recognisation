...
def main():
    ...
    test_accuracy = KNN(x_train, y_train, x_test, y_test,k_neighbor = 2)
    print('Test accuracy of k-NN with 2 neighbor with PCA')
    print(test_accuracy)
    ...
    test_accuracy = KNN(x_train, y_train, x_test, y_test,k_neighbor = 2)
    print('Test accuracy of k-NN with 2 neighbor with MDA')
    print(test_accuracy)
